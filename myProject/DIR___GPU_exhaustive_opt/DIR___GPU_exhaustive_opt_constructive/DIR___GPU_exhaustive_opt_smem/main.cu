...
#include "../../../common.h"
#include "GPU_exhaustive_opt_smem.h"
...
int main(int argc, char **argv){
    ...
    //CHECK(cudaDeviceSetCacheConfig(cudaFuncCachePreferShared)); <--- why does this make it so bad
    ...
    printf("recursive exhaustive GPU optimization smem, res: %d, event time: %f\n", res, msEvent);
